    ...
    $.each(question.answers, function(answer_index, answer) {
      ...
      if (correct) {
        ...
        opts = $.extend(opts, {
          title: "Vale",
          text: (
            "See ei olnud korrektne vastus<br/><br/>" +
            "Õige oli  \"" +
      ...
      if (last_question) {
        opts.confirmButtonText = "Vaata oma tulemust";
      }
...
function resultsText(state) {
  ...
  switch (true) {
    case (ratio === 1):
      text = "Wow&mdash; Vastasid kõik õigesti";
      break;
    case (ratio > 0.9):
      text = "Vinge töö, vastasid suuremosa õigesti";
      break;
    case (ratio > 0.60):
      text = "Päris hästi, saad positiivse hinde";
      break;
    case (ratio > 0.5):
      text = "Noh, vähemalt vastasid pooled õigesti&hellip;";
      break;
    case (ratio < 0.5 && ratio !== 0):
      text = "Tundub, et see test oli keeruline. Proovi aga uuesti!";
      break;
    case (ratio === 0):
      text = "Oih, mitte ükski vastus ei olnud korrektne!";
      break;
  }
  return text;
